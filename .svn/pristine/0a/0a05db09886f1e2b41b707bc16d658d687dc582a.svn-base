...
namespace Statistic
{
    public abstract class PanelAdmin : PanelStatisticWithTableHourRows
    {
        ...
        /// </summary>
        protected List<GroupBoxDividerChoice> gbxDividerChoices;
        /// <summary>
        ...
        protected virtual void InitializeComponents()
        {
            ...
            this.gbxDividerChoices = new List<GroupBoxDividerChoice> { new GroupBoxDividerChoice() };
            ...
            this.m_panelManagement.Controls.Add(this.gbxDividerChoices[0]);
            ...
            // gbxDividerChoice
            // 
            this.gbxDividerChoices[0].Initialize(posY);
            // 
            // btnLoadLayout
            // 
