    ...
    public partial class PanelAdminKomDisp : PanelAdmin
    {
        ...
        protected override void InitializeComponents()
        {
            ...
            int posY = 271
                ...
                , indx = -1;
            // массив областей(прямоугольных) для размещения активных элементов управления
            ...
            // добавить разделитель на панели с активными элементами управления
            ...
            // добавить разделитель на панели с активными элементами управления
            gbxDividerChoices.Add (new GroupBoxDividerChoice ());
            // добавить представление для расчета значений инициатив собственных
            ...
            #region Группа кнопок для применения рассчитанных значений инициатив собственных
            ...
            //this.buttonNewInitiativeAux.Text = "Нов.";
            ////
            //// buttonDeleteInitiativeAux
            ////
            ...
            //this.buttonDeleteInitiativeAux.Text = "Удалить";
            //
            // buttonApplyInitiativeAux
            //
            ...
            this.buttonApplyInitiativeAux.Text = "Применить";
        ...
        protected override void setDataGridViewAdmin(DateTime date, bool bResult)
        {
            ...
            if ((ModeGetRDGValues & AdminTS.MODE_GET_RDG_VALUES.DISPLAY) == AdminTS.MODE_GET_RDG_VALUES.DISPLAY) {
                ...
                if (bResult == true) {
                    ...
                    // отобразить точки с инициативами собственными
