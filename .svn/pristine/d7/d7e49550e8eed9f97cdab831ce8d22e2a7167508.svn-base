...
namespace strans
{
    partial class Host
    {
        private class ServiceBehavior : IServiceBehavior
        {
            private static string DefaultNamespace = "strans"; // "http://tempuri.org/"
            static readonly Func<Binding> createBinding = () => new WSDualHttpBinding ();
