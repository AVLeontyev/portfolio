...
namespace Statistic
{
    ...
    public partial class PanelVzletTDirect : PanelContainerStatistic
    {
        ...
        public partial class PanelTecVzletTDirect : PanelTecViewBase
        {
            ...
            private class ZedGraphControlVzletTDirect : HZedGraphControl
            {
                ...
                public override void Draw(TecView.valuesTEC[] values, params object[] pars)
                {
                    ...
                    GraphPane.AddCurve(strCurveNamePlan, /*null,*/ valuesPlan, FormMain.formGraphicsSettings.COLOR(FormGraphicsSettings.INDEX_COLOR_VAUES.UDG));
                    //LineItem
            ...
            protected override void InitializeComponent()
            {
                ...
                if (!(m_label == null))
                    m_label.PerformRestruct (BankName);
                else
        ...
        public partial class PanelTecVzletTDirect : PanelTecViewBase
        {
            ...
            {
                public HLabelTecVzletTDirect(BANK_DEFAULT bankName)
                    : base (bankName)
                {
            ...
            private class DataSource : TecView
            {
                ...
                {
                    string strQuery = m_tec.GetHoursVzletTDirectQuery(dt.Add(TimeSpan.Zero/*-HDateTime.TS_MSK_OFFSET_OF_UTCTIMEZONE*/ /* - m_tsOffsetToMoscow*/));
