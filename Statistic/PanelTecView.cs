...
namespace Statistic
{
    public class PanelTecView : PanelTecViewStandard
    {
        ...
        protected override void InitializeComponent () {
            ...
            this.m_ZedGraphMins.InitializeContextMenuItemAddingEventHandler(this.эксельToolStripMenuItemMins_Click, this.sourceDataMins_Click);
            this.m_ZedGraphHours.InitializeContextMenuItemAddingEventHandler(this.эксельToolStripMenuItemHours_Click, this.sourceDataHours_Click);
        }
