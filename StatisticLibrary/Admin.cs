...
namespace StatisticCommon
{
    ...
    public static partial class RDGStructExtensions
    {
        ...
        public static double UDGe (this HAdmin.RDGStruct [] values, double PBR_0, int iHour)
        {
        ...
        /// <returns>Значение УДГэ</returns>
        public static double UDGe (this HAdmin.RDGStruct value, double prevPbr)
        {
            return calculateUDGe (prevPbr, value.pbr, value.recomendation);
        }

        private static double calculateUDGe (double prevPbr, double currPbr, double rec)
        {
